...
${BOLD}NAME${RESET}
    ...
    ${BOLD}my-waybar-firejail${RESET} - waybar compatible firejail counter

    Small script that counts the currently firejail sandboxed programs.

${BOLD}SYNOPSYS${RESET}

    ${BOLD}my-waybar-firejail display${RESET}
    ${BOLD}my-waybar-firejail check${RESET}
    ${BOLD}my-waybar-firejail [--help|-h] ${RESET}
...
log_error() {
  message="$1"
  echo "$message" | systemd-cat -p err -t my-waybar-firejail
}
